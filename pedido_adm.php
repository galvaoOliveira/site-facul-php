...
<html>
		...
		<script type="text/javascript">
				...
				function verificar()
				{
				   ...
				   var nome, empresa, retirada, entrega, ruaent, bairroent, numeroent, ruaret, bairroret, numeroret, tipo, frag, telefone, celular, hora, minuto,selectUsuario;
                                   ...
                                   selectUsuario = pedidos.selectUsuario.value;

				   if ( selectUsuario == null)  
				   {
					  alert("Selecione o Usuario!");
					  pedidos.selectUsuario.style.background="yellow";
					  pedidos.selectUsuario.focus();
					  return false;
				   }else{
						pedidos.selectUsuario.style.background="white";
						}
	...
	<form name="pedidos" method="post" action="grava_pedido_adm.php">
...
$sql = "select cadUsuario from cadastro" ;
...
$linhasCons = mysql_fetch_array($rs);
                ...
                echo "<option value='".$linhasCons['cadUsuario']."'>".$linhasCons['cadUsuario'];
...
?>
		...
		<option value= "12"> Ãgua Branca
		<option value= "22"> Alphaville
		<option value= "9"> AngÃ©lica
		<option value= "21"> Barueri
		<option value= "5"> Belenzinho
		<option value= "4"> BrÃ¡s
		<option value= "15"> Congonhas
		<option value= "8"> ConsolaÃ§Ã£o
		<option value= "20"> Diadema
		<option value= "13"> Freguesia do Ã“
		...
		<option value= "19"> MauÃ¡ 
		<option value= "7"> Mooca
		<option value= "16"> Morumbi
		<option value= "3"> PoÃ¡
		<option value= "6"> TatuapÃ©	
		<option value= "14"> Santo Amaro
		<option value= "17"> Santo AndrÃ©
		<option value= "18"> SÃ£o Bernardo
		...
		<td>Número: <input type="text" name="txtnumeroretirada" size="5" placeholder="Número" required> </td>
		...
		<td>Número: <input type="text" name="txtnumeroentrega" size="5" placeholder="Número" required> </td>
		...
		<tr><td>Outros:</td><td> <input type="text" name="txtoutro" size="50" placeholder="Informe qual o tipo de entrega" required></td></tr>
