...
<html>
		...
		<title>Altere o seu cadastro!</title>
			...
			<script type="text/javascript">
                                ...
                                function selecionarDados(){
                                   var cadUsuario = document.alterar.selectUsuario.value ;
                                   document.alterar.codigoUsuario.value = cadUsuario ;
                                   document.alterar.action = "alterar_dados_adm.php" ; 
	...
	<form name="alterar" action="grava_alterar_dados_adm.php" method="post">
	...
	<form name="alterar" action="grava_alterar_dados_adm.php" method="post">
<input type="hidden" name="codigoUsuario" value="">
		...
		<td>
                 <select name="selectUsuario" onchange="selecionarDados()">
                 <option value="">
...
$codigoUsuario = isset($_REQUEST["codigoUsuario"])?$_REQUEST["codigoUsuario"]:"";

if ($codigoUsuario != "") {

include("conexao.php");

$sql2 = "select * from cadastro where cadUsuario='$codigoUsuario'" ;

$rs2 = mysql_query($sql2);


$linhasCons = mysql_fetch_array($rs2);
...
?>
                ...
                <input type="hidden" name="vUsuario" value="<?php echo $_REQUEST['codigoUsuario']; ?>">
		...
		<input type="button" value="voltar" onClick="location.href='meu_perfil_adm.php'" ></tr></td>
